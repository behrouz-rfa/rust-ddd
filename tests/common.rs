...
pub const USERNAME: &'static str = "behrouz7";
pub const EMAIL: &'static str = "behrouz.r.f7a@test.com";
pub const PASSWORD: &'static str = "test@123";
